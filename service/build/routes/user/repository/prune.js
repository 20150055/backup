...
exports.router.post("/:userId/repository/:repoId/prune", checkAuth_1.checkAuth, function (request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (repo) {
            ...
            if (repo.repoType === types_1.RepoType.Local) {
                resticOutput = yield scheduling_1.pruneRepo({
            ...
            if (resticOutput.success) {
                logInfo = {
                    ...
                    eventDescription: "api.success.backuprepository.prune",
                    message: "Prune successfull",
                ...
                logInfo = {
                    ...
                    eventDescription: "api.error.backuprepository.prune",
